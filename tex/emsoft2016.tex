...
However, ROS2 is under development and there is rooms to improve its performance and capability.
...
Finally, we also clarify a need of alternative API for large \emph{message} to manage divided packets.
