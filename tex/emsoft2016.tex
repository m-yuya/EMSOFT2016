...
\begin{table}[t]
  ...
  \begin{threeparttable}
    ...
    \begin{tabular}{c|c||c|c}
      ...
      \multicolumn{2}{c||}{Network} & \multicolumn{2}{c}{100 Mbps Ethernet / Half-Duplex} \\ \hline
...
In our one-way message transport experiment, maximum bandwidth ot the network is 12.5MB/sec because we use 100 Mbps Ethernet (100BASE-TX) and Half-Duplex as shown in \ref{tb:environment}.
