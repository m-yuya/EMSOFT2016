...
\end{flushleft}
  ...
  What this paper provides is not simple comparison between ROS1 and ROS2 but DDS characteristics throughout ROS2.
...
\end{flushleft}
  ...
  Following your advice, we have additionally conducted a throughout evaluation in Section 3.4.
...
\end{flushleft}
  ...
  This paper conducts proof of content for DDS approach to ROS and clarify DDS potentials.
...
\end{flushleft}
  ...
  \begin{itembox}[|]{Added sentences about ROS2 guideline in ``3.7 Lessons Learned'' section}
...
\end{flushleft}
  ...
  \begin{itembox}[|]{Added sentences about alternative API in ``3.7 Lessons Learned'' section}
...
\end{flushleft}
  ...
  \begin{itembox}[|]{Added a sentence in ``3.2 Capabilities of ROS1 and ROS2'' section}
...
\end{flushleft}
  ...
  \begin{itembox}[|]{Added sentences in ``3.7 Lessons Learned'' section}
  \end{itembox}\\
