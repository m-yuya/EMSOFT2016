...
\begin{figure}[t]
\centering
\includegraphics[width=1.0\linewidth]{../figure/ros_pubsub_fig.eps}
...
\begin{figure}[t]
\centering
\includegraphics[width=1.0\linewidth]{../figure/DDS_model.eps}
...
\begin{figure}[t]
\centering
\includegraphics[width=1.0\linewidth]{../figure/DDS_qos.eps}
...
\hline
RELIABILITY & In \texttt{BEST\_EFFORT}, data transport is executed as soon as possible. However, some data may be lost if the network is not robust. In \texttt{RELIABLE}, missed samples are retransmitted. Therefore, data delivery is guaranteed.\\
\hline
